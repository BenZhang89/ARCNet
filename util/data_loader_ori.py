...
class DataLoader():
    ...
    def __load_one_volume(self, patient_name, mod):
        ...
        # # temporary changed, in future needs more generatic codes
        # if 't2' in volume_name:
        #     volume = np.pad(volume, ((0,0),(36,0),(0, 0)), mode='constant', constant_values=0)
    ...
    def load_data(self):
        ...
        print('self.in_size is', self.in_size)
    ...
    def __get_one_batch(self):
        ...
        batch = {}
        batch['images']  = np.transpose(data_batch,   [0, 2, 3, 4, 1]) #axil 1 in the last, represent chans of t1 t1ce t2 flair
