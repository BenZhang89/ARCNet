...
class MSNet(TrainableLayer):
    ...
    def set_params(self, params):
        self.base_chns = params.get('base_feature_number', [32, 32, 32])
    ...
    def layer_op(self, images, is_training):
        ...
        block3_3 =  ResBlock(self.base_chns[2],
                  ...
                  name = 'block3_3')
        #ben
        block4_1 =  ResBlock(self.base_chns[2],
                  kernels = [[1, 3, 3], [1, 3, 3]],
                  dilation_rates = [[1, 3, 3], [1, 3, 3]],
                  acti_func=self.acti_func,
                  w_initializer=self.initializers['w'],
                  ...
                  name = 'block4_1')
        #ben:3 - 2
        block4_2 =  ResBlock(self.base_chns[2],
                  kernels = [[1, 3, 3], [1, 3, 3]],
                  dilation_rates = [[1, 2, 2], [1, 2, 2]],
                  acti_func=self.acti_func,
                  w_initializer=self.initializers['w'],
                  ...
                  name = 'block4_2')
        # ben:3 - 2
        block4_3 =  ResBlock(self.base_chns[2],
                  kernels = [[1, 3, 3], [1, 3, 3]],
                  dilation_rates = [[1, 1, 1], [1, 1, 1]],
                  acti_func=self.acti_func,
                  w_initializer=self.initializers['w'],
        ...
        fuse4 = ConvolutionalLayer(self.base_chns[2],
                    kernel_size= [3, 1, 1],
                    padding='VALID',
                    w_initializer=self.initializers['w'],
                    w_regularizer=self.regularizers['w'],
        ...
        feature_expand3 =  ConvolutionalLayer(self.base_chns[2],
                    kernel_size= [1, 1, 1],
                    stride = [1, 1, 1],
                    padding='SAME',
                    w_initializer=self.initializers['w'],
